...
import static com.shahaabco.satpa.SatpaSDK.SPlate;
...
public class VideoActivity extends CameraActivity implements CvCameraViewListener2, SensorEventListener {
    ...
    private SPlate plate, final_plate;
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        final SPlate p = anpr_recognize_mat(sub);
